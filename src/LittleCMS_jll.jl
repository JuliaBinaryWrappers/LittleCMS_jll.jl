...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import LittleCMS_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("d3a379c0-f9a3-5b72-a4c0-6bf4d2e8af0f"))
platforms = [Pkg.Artifacts.unpack_platform(e, "LittleCMS", artifacts_toml) for e in artifacts["LittleCMS"]]
...
if best_platform === nothing
    @debug("Unable to load LittleCMS; unsupported platform $(triplet(platform_key_abi()))")
else
