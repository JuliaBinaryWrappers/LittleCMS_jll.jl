...
const liblcms2_splitpath = ["bin", "liblcms2-2.dll"]
...
const liblcms2 = "liblcms2-2.dll"


# Relative path to `transicc`
const transicc_splitpath = ["bin", "transicc.exe"]
...
const psicc_splitpath = ["bin", "psicc.exe"]
...
const linkicc_splitpath = ["bin", "linkicc.exe"]
